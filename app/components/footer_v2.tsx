      ...
      <div className="bg-gray-800 py-4 text-gray-400">
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-between">
            ...
            <div className="my-4 w-full px-4 sm:w-auto xl:w-1/5">
              <div>
                <h2 className="mb-4 inline-block border-b-4 border-blue-600 pb-4 text-2xl">
                  Connect With Us
                </h2>
              ...
              <a
                href="#"
                className="mr-1 inline-flex h-8 w-8 items-center justify-center rounded-full border border-gray-100 hover:border-blue-400 hover:text-blue-400"
              >
                <svg
              ...
              <a
                href="#"
                className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-gray-100 hover:border-blue-400 hover:text-blue-400"
              >
                <svg
                  className="h-4 w-4 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
